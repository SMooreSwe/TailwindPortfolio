  ...
  return (
    <>
        ...
        <div className='icon-container'>
            ...
            <div className=''><img src="/c-sharp.png" alt="C-Sharp Icon" className="h-8"/></div>
            ...
            <div className=''><img src="/expressjs-icon.png" alt="ExpressJS Icon" className="h-8"/></div>
            <div className=''><img src="/react-icon.png" alt="React Icon" className="h-8"/></div>
