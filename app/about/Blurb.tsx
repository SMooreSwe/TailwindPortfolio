    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className='flex gap-2'>
          <img src="/wigPic.jpg" alt="my old work uniform" className='w-14 md:w-20 lg:w-24 aspect-auto blob3 border-2 border-secondary'/>
        ...
        <img src="/rubenPic.jpg" alt="my old work uniform" className='w-12 md:w-20 lg:w-24 aspect-auto blob2 border-2 border-secondary self-end mt-[-3%] xs:mt-0 mr-12'/>
